Чаще всего гистограммы применяют для анализа плотности данных: данные разделяются по величине на обычно равные промежутки (столбцы), считается количество данных каждого столбца и строится гистограмма.
